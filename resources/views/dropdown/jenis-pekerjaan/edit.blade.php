...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="col-md-8">
        <div class="card mb-2">
            <div class="card-body">
                <form action="{{ route('jenis-pekerjaan.update', $pekerjaan->id) }}" method="post">
                    @csrf
                    {{ method_field('patch') }}
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="kategoriPekerjaan" class="form-label">Jenis Pekerjaan</label>
                            <input type="text" name="jenis_pekerjaan" value="{{ $pekerjaan->pekerjaan }}" class="form-control">
                        </div>
                        <div class="col-md-8 mb-3">
                            <label for="deskripsiPekerjaan" class="form-label">Deskripsi Pekerjaan</label>
                            <textarea name="deskripsi_pekerjaan" class="form-control" rows="3" id="">{{ $pekerjaan->deskripsi_pekerjaan }}</textarea>
                        </div>
                    </div>
